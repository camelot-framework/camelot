...
public class PluginsResourceLocator extends ClasspathUriLocator {
    ...
    protected InputStream locateSingle(String uri) throws Exception { //NOSONAR
    ...
    protected InputStream locateMulti(String uri) throws Exception { //NOSONAR
    ...
    protected InputStream getInputStream(Plugin plugin, String path) throws Exception { //NOSONAR
