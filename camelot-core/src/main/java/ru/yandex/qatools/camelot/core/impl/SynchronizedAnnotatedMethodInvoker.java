 ...
 */
public class SynchronizedAnnotatedMethodInvoker<A> extends PluginAnnotatedMethodInvoker<A> {
    final HazelcastInstance hazelcastInstance;
    private final int timeoutSec;
    private final boolean unlockAfter;

    public SynchronizedAnnotatedMethodInvoker(HazelcastInstance hazelcastInstance, Plugin plugin, Class anClass,
