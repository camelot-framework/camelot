...
import ru.yandex.qatools.camelot.core.ScanMethodsAnnotatedWith;
...
public class Metadata {
    ...
    public static class ClassInfo<T> implements MetadataClassInfo<T> {
        ...
        private void addCollectedSuperclasses(Map<Class, Class[]> superclasses, Class... eventClass) {
