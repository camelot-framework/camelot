...
public interface PluginLoader {
     ...
     */
    ClassLoader createClassLoader(PluginsSource source) throws Exception;
     ...
     * @param source source for the loader
     */
    ClassLoader getClassLoader(PluginsSource source) throws Exception;
     ...
     * @param source source for the loader
     */
    InputStream getResourceAsStream(PluginsSource source, String path) throws Exception;
