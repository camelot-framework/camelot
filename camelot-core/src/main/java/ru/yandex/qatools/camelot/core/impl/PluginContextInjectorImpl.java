...
public class PluginContextInjectorImpl<P> implements PluginContextInjector<P> {
    ...
    private static final Map<Class, Map<Class<? extends Annotation>, Collection<Pair<AnnotationInfo, Field>>>> cache = new ConcurrentHashMap<>();
    ...
    private void performInjection(final Object object, final PluginContext context, final Exchange exchange) {
        try {
            injectField(object.getClass(), Listener.class, object, context.getListener());
            ...
            injectField(object.getClass(), ClientSender.class, object, new FieldListener<ClientMessageSender>() {
                @Override
                public ClientMessageSender found(Field field, AnnotationInfo info) throws Exception {
            ...
            injectField(object.getClass(), Plugins.class, object, new FieldListener<PluginsInterop>() {
                @Override
                public PluginsInterop found(Field field, AnnotationInfo info) throws Exception {
            ...
            injectField(object.getClass(), ConfigValue.class, object, new FieldListener<Object>() {
                @Override
                public Object found(Field field, AnnotationInfo annotation) throws Exception {
            ...
            if (exchange != null) {
                ...
                injectField(object.getClass(), InjectHeaders.class, object, new FieldListener<Map<String, Object>>() {
                    @Override
                    public Map<String, Object> found(Field field, AnnotationInfo annotation) throws Exception {
    ...
    protected <T extends Annotation> Collection<Pair<AnnotationInfo, Field>> getFields(final Class clazz, final Class<T> annClass) throws Exception {
        ...
        if (!cache.get(clazz).containsKey(annClass)) {
            ...
            forEachAnnotatedField(clazz, annClass, new AnnotatedFieldListener<Object, T>() {
                @Override
                public Object found(Field field, T annotation) throws Exception {
    ...
    @SuppressWarnings("unchecked")
    protected synchronized void cacheClassInfo(Class clazz) throws Exception {
    ...
    protected <T, U extends Annotation> void injectPluginRelatedField(Object object, final Class<U> ann, final InjectHandler<T> handler) throws Exception {
    ...
    protected <T, A extends Annotation> void injectField(Class clazz, Class<A> annClass, final Object instance, final T value) throws Exception {
    ...
    protected <A extends Annotation> void injectField(Class clazz, Class<A> annClass, final Object instance,
                                                      final FieldListener listener) throws Exception {
...
//                    field.setAccessible(oldAccessible);
    ...
    protected <A extends Annotation> void eachField(Class clazz, Class<A> annClass, FieldListener listener) throws Exception {
